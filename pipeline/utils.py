...
def put_text(img, text, origin, color, shadow_offset=(1,1), font=cv2.FONT_HERSHEY_SIMPLEX, size=0.5, thickness=1, line_type=cv2.LINE_AA):
    ...
    loc = min(max(origin[0] - 50, 10), img.shape[1] - 80), min(max(origin[1] - 20, 30), img.shape[0] - 50)
